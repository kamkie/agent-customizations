...
- Run user-requested and repository-required checks, even when the request does not name tests. Otherwise choose tests proportionate to the change; avoid adding tests for reversible, low-impact changes or tests that only mirror the implementation.
